  ...
  try {
    ...
    movies.forEach(function (movies) {
      ...
      resultContainer.innerHTML += `<div class="movie-item">
                                        <a href="/movie_creator.html?id=${movies.id}"><img class="movie-cover" src=${movies.images[0].src} alt="${movies.images[0].alt}"/></a>
                                        <div class="movie-rating">${movieRating}</div>
                                        <h3 class="movie-title">${movies.name}</h3>
                                        <a href="/movie_creator.html?id=${movies.id}" class="cta cta_play-now"
